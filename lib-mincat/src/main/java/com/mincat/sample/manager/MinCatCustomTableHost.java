...
/**
 * @modify Gin
 * @描述 自定义TableHost 不会出现重复加载
 */
public class MinCatCustomTableHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public MinCatCustomTableHost(Context context) {
    ...
    public MinCatCustomTableHost(Context context, AttributeSet attrs) {
        super(context, attrs);
