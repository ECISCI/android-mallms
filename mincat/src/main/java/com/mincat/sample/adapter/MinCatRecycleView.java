package com.mincat.sample.adapter;
...
import com.mincat.sample.adapter.inter.MinCatAdapterItemClickListener;
 ...
 * @author Gin
 */
public abstract class MinCatRecycleView<T, F extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<F> {


    protected Context context;
    protected List<T> data = new ArrayList<T>();

    private MinCatAdapterItemClickListener<T, F> recItemClick;

    public MinCatRecycleView(Context context) {
    ...
    public void setRecItemClick(MinCatAdapterItemClickListener<T, F> recItemClick) {

        this.recItemClick = recItemClick;
    }

    public MinCatAdapterItemClickListener<T, F> getRecItemClick() {
        return recItemClick;
    }
