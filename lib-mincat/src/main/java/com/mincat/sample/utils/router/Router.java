...
public class Router {
    ...
    private int enterAnim = Constants.ROUTER_ANIM_ENTER;
    private int exitAnim = Constants.ROUTER_ANIM_EXIT;
    ...
    public static Router newIntent(Activity context) {
        ...
        router.from = context;
        router.anim(R.anim.slide_in_left, R.anim.slide_out_right);
        return router;
    }
